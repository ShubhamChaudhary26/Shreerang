...
const HeroSection = () => {
  return (
    <section className="relative h-[62vh] mt-[10vh] mb-10 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2  mx-auto relative z-10  md:py-0 max-w-[1440px] ">
        ...
        >
          <div className=" mx-auto md:mx-0">
            {/* <p className="h5 ">Perspectives</p> */}
          <h1 className="h1">
           Explore MintSurvey process and quality assurance
          </h1>
        ...
        >
          <div className="w-full h-full max-w-sm md:max-w-full flex justify-center items-center">
            <img
              src="/inspiration/herosection.svg"
