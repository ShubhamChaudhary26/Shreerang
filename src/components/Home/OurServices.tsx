...
const services = [
  {
    ...
    details: "Our trained executives ensure accurate biometric capture and assist with form submission at your doorstep.",
  },
  {
    icon: <FaMapMarkerAlt size={32} />,
    title: "Service Across India",
    description: "Available in Mumbai, Pune, Nashik, Nagpur & other major cities.",
    details: "No matter where you are, Shreerang Associates ensures you get the same premium service across all locations.",
  },
  {
    ...
    details: "All agreements are compliant with government standards and fully recognized legally.",
  },
  {
    ...
    details: "You get full control over your agreement draft to ensure all terms are accurate and transparent.",
  },
  {
    icon: <FaUserShield size={32} />,
    title: "100% Legal Support",
    description: "Compliant with government rules, accepted by police & court.",
    details: "Our legal experts provide guidance at every step and assist in resolving any queries post-registration.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            Shreerang Associates offers complete property and rent agreement solutions with expert support, legal validation, and doorstep convenience across India.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            <SwiperSlide key={index}>
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 shadow-md border border-gray-200 flex flex-col items-center text-center h-[320px] mx-5 my-5 hover:shadow-xl transition duration-300"
              >
                {/* Icon Circle */}
                ...
                {/* Description */}
                <p className="text-gray-700 text-sm md:text-base mb-2">{service.description}</p>
                {/* Extra Details */}
